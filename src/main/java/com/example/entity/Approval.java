...
public class Approval {
    ...
    public Approval(int id, String maplnfo_name, String single_name, String unit_name, String partial_name, String project_name, double old_match, double new_match, String signalment, int item_id, int dic_id) {
        this.id = id;
